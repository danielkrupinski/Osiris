...
struct UiItem3dPanelPatterns {
    [[nodiscard]] static consteval auto addClientPatterns(auto clientPatterns) noexcept
    {
        return clientPatterns
            ...
            .template addPattern<OffsetToItem3dPanelUnknownField, CodePattern{"48 8B D7 ? 8D 4E ? FF 15 ? ? ? ? ? 89 76 ?"}.add(16).read()>()
            .template addPattern<OffsetToStartWeaponLookAt, CodePattern{"66 C7 86 ? ? ? ? 01 00 8B"}.add(3).read()>()
