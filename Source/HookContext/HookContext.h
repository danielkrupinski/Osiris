...
private:
    ...
    {
        const auto* const plantedC4Head = fullGlobalContext.patternSearchResults.template get<PlantedC4sPointer>();
        if (plantedC4Head && *plantedC4Head)
            return *plantedC4Head;
        return nullptr;
    }
