...
using ConfigVariableTypes = TypeList<
    ...
    PlayerOutlineGlowPlayerBlueHue,
    PlayerOutlineGlowPlayerGreenHue,
    PlayerOutlineGlowPlayerYellowHue,
    PlayerOutlineGlowPlayerOrangeHue,
    PlayerOutlineGlowPlayerPurpleHue,
    PlayerOutlineGlowTeamTHue,
    PlayerOutlineGlowTeamCTHue,
    PlayerOutlineGlowLowHealthHue,
    PlayerOutlineGlowHighHealthHue,
    PlayerOutlineGlowAllyHue,
    PlayerOutlineGlowEnemyHue,
    OutlineGlowMolotovHue,
    OutlineGlowFlashbangHue,
    OutlineGlowHEGrenadeHue,
    OutlineGlowSmokeGrenadeHue,
    OutlineGlowDroppedBombHue,
    OutlineGlowTickingBombHue,
    OutlineGlowDefuseKitHue
>;
