...
unsigned int Helpers::calculateColor(const Memory& memory, Color4 color) noexcept
{
...
unsigned int Helpers::calculateColor(const Memory& memory, Color3 color) noexcept
{
