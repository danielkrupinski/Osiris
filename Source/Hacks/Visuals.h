...
namespace Visuals
{
    ...
    void removeGrass(const Interfaces& interfaces, csgo::FrameStage stage) noexcept;
    ...
    void applyScreenEffects(const Interfaces& interfaces, const Memory& memory) noexcept;
    void hitEffect(const Interfaces& interfaces, const Memory& memory, GameEvent* event = nullptr) noexcept;
    void hitMarker(const Interfaces& interfaces, const Memory& memory, GameEvent* event, ImDrawList* drawList = nullptr) noexcept;
    ...
    void bulletTracer(const ClientInterfaces& clientInterfaces, const Interfaces& interfaces, const Memory& memory, GameEvent& event) noexcept;
