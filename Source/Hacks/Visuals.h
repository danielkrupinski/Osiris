...
namespace Visuals
{
    ...
    void colorWorld(const Memory& memory) noexcept;
    ...
    void applyScreenEffects(const Memory& memory) noexcept;
    void hitEffect(const Memory& memory, GameEvent* event = nullptr) noexcept;
    void hitMarker(const Memory& memory, GameEvent* event, ImDrawList* drawList = nullptr) noexcept;
    ...
    void skybox(const Memory& memory, csgo::FrameStage stage) noexcept;
    void bulletTracer(const Memory& memory, GameEvent& event) noexcept;
