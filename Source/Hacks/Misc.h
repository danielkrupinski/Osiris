...
namespace Misc
{
    ...
    void stealNames(const ClientInterfaces& clientInterfaces, const Interfaces& interfaces, const Memory& memory) noexcept;
    ...
    void fixAnimationLOD(const ClientInterfaces& clientInterfaces, const Interfaces& interfaces, const Memory& memory, csgo::FrameStage stage) noexcept;
    ...
    void purchaseList(const ClientInterfaces& clientInterfaces, const Interfaces& interfaces, const Memory& memory, GameEvent* event = nullptr) noexcept;
    void oppositeHandKnife(const Interfaces& interfaces, csgo::FrameStage stage) noexcept;
    void runReportbot(const ClientInterfaces& clientInterfaces, const Interfaces& interfaces, const Memory& memory) noexcept;
    ...
    void updateEventListeners(const ClientInterfaces& clientInterfaces, const Interfaces& interfaces, const Memory& memory, bool forceRemove = false) noexcept;
