...
static_assert(PlayerOutlineGlowPlayerBlueHue::ValueType::kMin == 191, "Update below test");
static_assert(PlayerOutlineGlowPlayerGreenHue::ValueType::kMin == 110, "Update below test");
static_assert(PlayerOutlineGlowPlayerYellowHue::ValueType::kMin == 47, "Update below test");
static_assert(PlayerOutlineGlowPlayerOrangeHue::ValueType::kMin == 11, "Update below test");
static_assert(PlayerOutlineGlowPlayerPurpleHue::ValueType::kMin == 250, "Update below test");
...
static_assert(PlayerOutlineGlowPlayerBlueHue::ValueType::kMax == 240, "Update below test");
static_assert(PlayerOutlineGlowPlayerGreenHue::ValueType::kMax == 140, "Update below test");
static_assert(PlayerOutlineGlowPlayerYellowHue::ValueType::kMax == 60, "Update below test");
static_assert(PlayerOutlineGlowPlayerOrangeHue::ValueType::kMax == 20, "Update below test");
static_assert(PlayerOutlineGlowPlayerPurpleHue::ValueType::kMax == 280, "Update below test");
