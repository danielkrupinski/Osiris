...
TEST(Utils_PatternFinderTest, PatternCanBeFoundWithSIMD) {
    ...
    EXPECT_EQ(PatternFinder{ bytes }("DE AD ? C0 DE"_pat).get(), std::uintptr_t(&bytes[41]));
}
