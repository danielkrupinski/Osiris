...
void Config::load(size_t id) noexcept
{
...

    {
        ...
        if (antiAimJson.isMember("Lby")) antiAim.lby = antiAimJson["Lby"].asBool();
        if (antiAimJson.isMember("Indicators")) antiAim.indicators = antiAimJson["Indicators"].asBool();
...
void Config::save(size_t id) const noexcept
{
...

    {
        ...
        antiAimJson["Lby"] = antiAim.lby;
        antiAimJson["Indicators"] = antiAim.indicators;
