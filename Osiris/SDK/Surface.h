...
public:
    ...
    {
        callVirtualFunction<void, void*, int, int, int, int>(this, 25)(this, r, g, b, a);
    }

    constexpr void setTextPosition(int x, int y) noexcept
    {
        callVirtualFunction<void, void*, int, int>(this, 26)(this, x, y);
    }

    constexpr void printText(const std::wstring_view text, int drawType = 0) noexcept
    {
        callVirtualFunction<void, void*, const wchar_t*, int, int>(this, 28)(this, text.data(), text.length(), drawType);
    }

    auto getScreenSize() noexcept
    {
        int width, height;
        callVirtualFunction<void, void*, int&, int&>(this, 44)(this, width, height);
        return std::make_pair(width, height);
    }

    constexpr unsigned createFont() noexcept
    {
        return callVirtualFunction<unsigned, void*>(this, 71)(this);
    }
    ...
    {
        return callVirtualFunction<bool, void*, unsigned, const char*, int, int, int, int, int, int, int>(this, 72)(this, font, fontName, tall, weight, blur, scanlines, flags, rangeMin, rangeMax);
    }
};
