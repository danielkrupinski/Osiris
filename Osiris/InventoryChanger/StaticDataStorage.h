...
public:
    ...
    void addMusic(int musicID, StaticData::ItemName name, std::string_view inventoryImage)
    {
        ...
        addItem(StaticData::GameItem::musicKit(EconRarity::Blue, musicKits.size() - 1, inventoryImage));
    }

    void addVanillaKnife(WeaponId weaponID, std::string_view inventoryImage)
    {
        addItem(StaticData::GameItem::skin(EconRarity::Red, weaponID, vanillaPaintIndex, inventoryImage));
    }
    ...
    {
        addItem(StaticData::GameItem::skin(EconRarity::Default, weaponID, vanillaPaintIndex, inventoryImage));
    }
