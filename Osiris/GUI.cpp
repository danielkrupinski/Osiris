...
void GUI::renderAimbotWindow(bool contentOnly) noexcept
{
    ...
    ImGui::SliderInt("Max distance", &config->aimbot[currentWeapon].maxDistance, 0, 300, "%d m");
...
{
    ImGui::Begin("BagCox", nullptr, windowFlags | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_AlwaysAutoResize);
