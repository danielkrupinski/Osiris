...
Memory::Memory() noexcept
{
    ...
    setAbsOrigin = findPattern<decltype(setAbsOrigin)>("client_panorama", "\x55\x8B\xEC\x83\xE4\xF8\x51\x53\x56\x57\x8B\xF1\xE8");
    animationLayerCount = *reinterpret_cast<uintptr_t*>(findPattern<>("client_panorama", "\x8B\x97????\x85\xD2\x75\x07", 2));
    animationLayer = *reinterpret_cast<uintptr_t*>(findPattern<>("client_panorama", "\x8B\x9F????\x8D\x43\x14", 2));
}
