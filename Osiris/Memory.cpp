...
Memory::Memory() noexcept
{
    ...
    traceToExit = findPattern("client", "\x55\x8B\xEC\x83\xEC\x30\xF3\x0F\x10\x75");
    ...
    getPlayerViewmodelArmConfigForPlayerModel = relativeToAbsolute<decltype(getPlayerViewmodelArmConfigForPlayerModel)>(findPattern("client", "\xE8????\x89\x87????\x6A") + 1);
