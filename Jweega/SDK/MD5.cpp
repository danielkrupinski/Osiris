...
// Output : static void
//-----------------------------------------------------------------------------
static constexpr void transform(unsigned int buf[4], unsigned int const in[16]) noexcept
{
...
// Input  : *ctx -
//-----------------------------------------------------------------------------
static constexpr void init(MD5Context_t* ctx) noexcept
{
...
//			len -
//-----------------------------------------------------------------------------
static constexpr void update(MD5Context_t* ctx, unsigned char const* buf, unsigned int len) noexcept
{
    //unsigned int t;
...
//			*ctx -
//-----------------------------------------------------------------------------
static inline void final(unsigned char digest[MD5_DIGEST_LENGTH], MD5Context_t* ctx) noexcept
{
    unsigned count;
    unsigned char* p;
